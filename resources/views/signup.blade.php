...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap"
        rel="stylesheet" />
    <link rel="shortcut icon" href="{{ asset('src/images/logo.ico') }}" type="image/x-icon" />
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.4/jquery.min.js"
        integrity="sha512-pumBsjNRGGqkPzKHndZMaAG+bir374sORyzM3uulLV14lN5LyykqNk8eEeUlUkB3U0M4FApyaHraT65ihJhDpQ=="
        crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="{{ asset('js/signup.js') }}" type="module" defer></script>
    <link rel="stylesheet" href="{{ asset('css/signup.css') }}" />
    <!-- <link rel="stylesheet" href="{{ asset('src/css/root.css') }}"> -->
...
<body>
    <main>
        ...
        <section class="left-wrapper">
            <!-- <img src="{{ asset('src/images/sgn-banner-mobile.svg') }}" class="left-bg" alt="" hidden> -->
            <div class="heading-wrapper">
                <h2 class="header">Create account</h2>
                <p class="create-account-descr">
                    Create your account by entering <br />
                    below details.
                </p>
                <p class="email-send-text"></p>
                <p></p>
            </div>

            <form action="{{ route('signup') }}" method="POST" class="sign-up-form" autocomplete="off">
                @csrf
                ...
                <div class="main-wrapper">
                    ...
                    <div class="input-wrapper">
                        ...
                        <p class="password-err">
                            The password should be at least 8 characters long
                        </p>
                        <p class="wrong-pass-err">
                            The password you entered is incorrect.
                        </p>
                    </div>
                </div>
                <div class="btn-wrapper">
                    <button id="sign-up" data-action="personal" type="submit">
                        Sign-up
                    </button>
                </div>
            ...
            <div class="signup-wrapper">
                <span>Already have an account?</span><a href="{{ route('signin') }}" rel="noopener noreferrer"
                    class="singup-anchor" id="signin-button">Sign in</a>
            </div>
        </section>
